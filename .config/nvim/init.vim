...
autocmd BufWritePre *.c,*.css,*.h,*.html,*.md,*.markdown,*.nf,*.js,*.py,*.rs,*.sh,*.sql,*.tex,*.toml,*.txt,*.yaml :call <SID>StripTrailingWhitespaces()
...
" select target tmux session, window, and pane
" TODO rewrite in Lua and improve
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
